  ...
  return (
    <SafeAreaView style={s.safe} edges={['top']}>
      ...
      >
        ...
        <View style={s.header}>
          <View>
            <Text style={s.greeting}>Merhaba, {firstName} 👋</Text>
            <Text style={s.greetingSub}>Bugün nasılsın?</Text>
          </View>
        ...
        <View style={s.card}>
          ...
          <View style={s.cardTop}>
            <View>
              <Text style={s.cardLabel}>Toplam Bakiye</Text>
              <Text style={s.cardBalance}>₺{displayBalance}</Text>
            </View>
